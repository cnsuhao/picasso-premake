...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/shadow
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/shadow
...
$(OBJDIR)/shadow_func.o: ../test/shadow_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
