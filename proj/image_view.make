...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/image_view
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/image_view
  ...
  LIBS      += -lpicasso2_sw -lpsx_image -lz -lfreetype -ldl
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += ../bin/libpicasso2_sw.so ../bin/libpsx_image.so
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/image_view
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/image_view
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/image_view
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/image_view
  DEFINES   += -D_DEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/image_view
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/image_view
  DEFINES   += -DNDEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
$(OBJDIR)/image_view.o: ../test/image_view.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
