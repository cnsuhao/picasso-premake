...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/image_info
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/image_info
  ...
  LIBS      += -lpicasso2_sw -lpsx_image -lz -lfreetype -lfontconfig -ldl
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/image_info
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/image_info
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/image_info
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/image_info
  DEFINES   += -D_DEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/image_info
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/image_info
  DEFINES   += -DNDEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
$(OBJDIR)/image_info.o: ../test/image_info.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
