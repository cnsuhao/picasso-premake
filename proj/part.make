...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/part
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/part
...
$(OBJDIR)/part_func.o: ../test/part_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
