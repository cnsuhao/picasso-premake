...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/gamma
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/gamma
...
$(OBJDIR)/gamma_func.o: ../test/gamma_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
