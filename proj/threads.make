...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/threads
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/threads
  ...
  LIBS      += -lpicasso2_sw -lpthread -lz -lfreetype
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/threads
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/threads
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/threads
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/threads
  DEFINES   += -DNDEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
$(OBJDIR)/thread_func.o: ../test/thread_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
$(OBJDIR)/testGtk2.o: ../test/testGtk2.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
$(OBJDIR)/thr_posix.o: ../test/thr_posix.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
