...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/gradient
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/gradient
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/gradient
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/gradient
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/gradient
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/gradient
  DEFINES   += -DNDEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
$(OBJDIR)/gradient_func.o: ../test/gradient_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
