...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/bitblt
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/bitblt
...
$(OBJDIR)/bitblt_func.o: ../test/bitblt_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
