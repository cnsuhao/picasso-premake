...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/mask
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/mask
...
$(OBJDIR)/mask_func.o: ../test/mask_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
