...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/clip
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/clip
...
$(OBJDIR)/clip_func.o: ../test/clip_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
