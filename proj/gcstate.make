...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/gcstate
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/gcstate
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/gcstate
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/gcstate
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/gcstate
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/gcstate
  DEFINES   += -DNDEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
$(OBJDIR)/gcstate_func.o: ../test/gcstate_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
