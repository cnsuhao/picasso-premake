...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/alpha
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/alpha
...
$(OBJDIR)/alpha_func.o: ../test/alpha_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
