...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/text
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/text
...
$(OBJDIR)/text_func.o: ../test/text_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
