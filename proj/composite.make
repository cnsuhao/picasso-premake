...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/composite
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/composite
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/composite
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/composite
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/composite
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/composite
  DEFINES   += -D_DEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/composite
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/composite
  DEFINES   += -DNDEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
$(OBJDIR)/composite_func.o: ../test/composite_func.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
