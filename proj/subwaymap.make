...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/subwaymap
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/subwaymap
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/subwaymap
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/subwaymap
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/subwaymap
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/subwaymap
  DEFINES   += -D_DEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/subwaymap
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/subwaymap
  DEFINES   += -DNDEBUG -DENABLE_FREE_TYPE2=1 -DENABLE_FONT_CONFIG=1
  INCLUDES  += -I../include -I../build -I../test
...
$(OBJDIR)/subwaymap.o: ../demos/subwaymap.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
